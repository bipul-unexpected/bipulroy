/**
 * SplashCursor — WebGL fluid mouse trail (from SomratChandraRoy/copy repo)
 * Adapted for Vite + Creativity purple light theme.
 */
...
export default function Cursor({
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      // Creativity purple range (violet → magenta)
